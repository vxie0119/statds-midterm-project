...
correlation = merged_df[['n_sighting', 'population_density', 'median_household_income']].corr()
...
plt.title('Average Income vs. Rodent Sightings')
plt.show()

# Step 4: Statistical Testing
# Linear regression model for hypothesis testing
# Dependent variable: number of sightings; 
# Independent variables: population density and median household income
model = ols('n_sighting ~ population_density + median_household_income', data=merged_df).fit()

# Display the results of the hypothesis test
hypothesis_test_results = model.summary()
print(hypothesis_test_results)

# Step 5: Interpretation
# Based on the output of the correlation and plots, you would interpret the results.

# Example Interpretation in non-technical terms:
# "Areas with higher population densities seem to have more rodent sightings, which could be due to the availability of more food and shelter for rodents. On the other hand, average income does not show a clear relationship with the number of rodent sightings. This might indicate that income level is not a direct factor in rodent sightings or that other factors could be at play."
```
