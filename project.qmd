...
merged_df = pd.merge(aggregated_sightings, zipcode_df, left_on='ZIP_CODE', right_on='zipcode', how='left')

# Handle NaN or infinite values
merged_df.replace([np.inf, -np.inf], np.nan, inplace=True)
merged_df.dropna(subset=['n_sighting', 'population_density', 'median_household_income', 'initial_pass_rate', 'median_home_value'], inplace=True)

# Predictor Variables
X = merged_df[['n_sighting', 'population_density', 'median_household_income', 'median_home_value']]
